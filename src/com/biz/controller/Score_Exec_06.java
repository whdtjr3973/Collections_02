...
public class Score_Exec_06 {
	...
	public static void main(String[] args) {
		...
		/*
		 * List의 크기를 알수있는 method로 List.size()가 있는데
		 * 이 List.size() 메서드는 호출할떄마다 매번 List의 개수를
		 * 계산한다. 따라서 배열의 length와는 성질이 달라서
		 * for문 내에서 가급적 사용하지 말고 
		 * for문을 시작하기전에 변수에 담아놓고 for문을 실행하는
		 * 것이 좋다.
		 */
		int scLen = scList.size();
		for(int i =0; i < scLen ; i++) {
			// scList의 i번쨰 위치에 저장된 ScoreVO의 주소를 읽어서
			// vo에 담아달라
